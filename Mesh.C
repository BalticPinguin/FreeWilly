...
void add_sphere_convex_hull_to_mesh2(MeshBase& mesh, libMesh::Real r_max, unsigned int points_on_sphere, std::vector<Point> geometry, std::string creator, const double L, const double N);
