...
#ifndef LIBMESH_RADIAL_INTERPOLATION_H
#define LIBMESH_RADIAL_INTERPOLATION_H
...
class RadialInterpolation : public MeshfreeInterpolation
{
protected:
  ...
  /* store array with the geometries:
  */
...
public:
  ...
  /**
   * Constructor. Takes the geometry of the molecule of interest.
   */
  RadialInterpolation (const libMesh::Parallel::Communicator & comm_in,
                                const std::vector<Points> molecule_geom) :
...
#endif // #define LIBMESH_RADIAL_INTERPOLATION_H
